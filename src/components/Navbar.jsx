      ...
      <div className="bg-slate-900 text-slate-300 text-xs py-2 px-4 sm:px-6 lg:px-8 border-b border-slate-800">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2">
          ...
          <div className="flex items-center gap-3.5 flex-wrap justify-center">
            ...
            >
              <Phone className="w-3.5 h-3.5 text-skybrand-400" />
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 text-xs font-semibold transition cursor-pointer"
          ...
          <div className="flex items-center justify-between">
            ...
            <a href="#home" className="flex items-center gap-3 group focus:outline-none shrink-0">
              <img 
                ...
                className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl object-contain shadow-sm border border-slate-100 bg-white"
              />
            ...
            <div className="hidden lg:flex items-center gap-1 xl:gap-2">
              {navLinks.map((link, idx) => (
                <a
                  key={idx}
                  href={link.href}
                  className="px-3.5 py-2 rounded-lg text-sm font-medium text-slate-700 hover:text-skybrand-600 hover:bg-slate-50 transition-colors"
                >
                  {link.name}
                </a>
              ))}
            ...
            <div className="hidden sm:flex items-center gap-3">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl font-bold text-xs sm:text-sm text-white bg-gradient-to-r from-skybrand-600 to-dental-500 hover:from-skybrand-700 hover:to-dental-600 shadow-md shadow-skybrand-500/20 transition-all duration-200 active:scale-95"
              >
