    ...
    <section id="reviews" className="py-16 lg:py-24 bg-white relative overflow-hidden border-t border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-skybrand-100 text-skybrand-700 text-xs sm:text-sm font-bold uppercase tracking-wider mb-3">
        ...
        <div className="bg-slate-50 rounded-3xl p-6 sm:p-10 border border-slate-200 shadow-soft max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            <div className="md:col-span-5 flex flex-col items-center justify-center text-center p-6 sm:p-8 bg-white rounded-2xl border border-slate-200 shadow-sm">
              <div className="text-5xl sm:text-6xl font-black text-slate-900 tracking-tight mb-1">
                {reviewsSummary.rating}
              </div>

              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 font-bold text-sm my-2">
              ...
              <a
                ...
                className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-slate-900 hover:bg-slate-800 text-white text-sm sm:text-base font-bold transition shadow-sm"
              >
            ...
            <div className="md:col-span-7 space-y-4">
              ...
              <div className="pt-1 flex items-center gap-2 text-sm text-slate-600">
