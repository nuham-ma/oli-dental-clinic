      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-start">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-skybrand-50 border border-skybrand-200 text-skybrand-700 text-xs sm:text-sm font-bold uppercase tracking-wider mb-4">
            ...
            <div className="flex flex-wrap items-center gap-3.5">
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl font-bold text-base text-white bg-gradient-to-r from-skybrand-600 to-dental-500 hover:from-skybrand-700 hover:to-dental-600 shadow-md transition hover-lift active:scale-95"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-3.5 rounded-xl font-semibold text-base text-slate-700 bg-slate-100 hover:bg-slate-200 transition hover-lift"
              >
