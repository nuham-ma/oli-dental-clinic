        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="bg-slate-50 p-4 sm:p-5 rounded-2xl border border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <button
                onClick={handleCopy}
                className="shrink-0 px-4 py-2.5 rounded-xl bg-white border border-slate-200 hover:bg-slate-100 text-skybrand-600 text-sm font-bold flex items-center gap-1.5 transition cursor-pointer shadow-sm"
              >
              ...
              {submitted ? (
                <div className="p-5 bg-emerald-50 rounded-xl border border-emerald-200 text-center animate-in zoom-in-95">
                  ...
                  <button
                    ...
                    className="px-5 py-2 rounded-lg bg-emerald-600 text-white text-sm font-bold shadow-sm"
                  >
                ...
                <form onSubmit={handleInquirySubmit} className="space-y-3.5">
                  ...
                  <button
                    type="submit"
                    className="w-full py-3.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-bold text-base shadow-sm transition flex items-center justify-center gap-2 cursor-pointer"
                  >
